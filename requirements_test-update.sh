...
HERE="$(dirname "$0")"
REQUIREMENTS_FILE="${HERE}/requirements_test.txt"
...
pip-compile --allow-unsafe --generate-hashes --upgrade --rebuild --verbose --annotate --output-file="${REQUIREMENTS_FILE}" requirements_test.in
